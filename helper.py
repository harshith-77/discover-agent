...
class Helper:
    ...
    def initialize_tools() -> list:
        ...
        datetime_tool = Tool(
            name='date_and_time',
            description="Use this tool whenever you want to know the current date or time. The input to this tool is 'now', output is today's date and current time.",
    ...
    def initialize_llm():
        ...
        llm = ChatGroq(model='qwen/qwen3-32b', api_key=os.environ['GROQ_API_KEY'], reasoning_format='parsed')
        return llm
